...
/**
 * The persistent class for the uos_uif_phon database table.
 * 
 */
@Entity
@Table(name="uos_uif_phon")
@NamedQuery(name="UosUifPhon.findAll", query="SELECT u FROM UosUifPhon u")
public class UosUifPhon implements Serializable {
